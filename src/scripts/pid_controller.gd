...
## By https://gist.github.com/mattogodoy
...
# PID coefficients
@export_range(0, 1, 0.01) var proportional_gain: float
@export_range(0, 1, 0.01) var integral_gain: float
@export_range(0, 1, 0.01) var derivative_gain: float

@export var output_min: float = -1
@export var output_max: float = 1
@export_range(0, 1, 0.01) var integral_saturation: float
